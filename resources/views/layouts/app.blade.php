                            ...
                            <div class="d-flex justify-content-center py-2">
                                <div class="text-center">
                                    <a href="" class="logo align-items-center w-auto">
                                        <img src="{{ url('assets/img/iconPic.png') }}" alt="Logo"
                                            style="max-height: 236px; margin-right: 6px;">
                                        <span style="display: block; margin-bottom: 5px;"></span>
                                        <!-- Adjusted margin-bottom -->
                                    </a>
                                    <div>
                                        <h5 class="card-title text-center pb-0 fs-4">Icon Place</h5>
                                    </div>
                                </div>
                            </div><!-- End Single Div for Logo and Text with Space -->
