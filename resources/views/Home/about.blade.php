...
<html>
  <head>
    ...
    <title>
      RWANDA PENTECOSTAL ASSEMBLIES OF GOD (RPAG) - Assemblies of God Kanombe
    </title>
                ...
                >
                  <a href="index.html" class="d-flex align-items-center">
                    ...
                    <div class="logo-text text-center">
                      ...
                      <span class="kanombe-text"
                        >Assemblies of God-Kanombe</span
                      >
                    </div>
                  </a>
                </div>
            ...
            <div class="ticker-wrap">
              <div class="ticker">
                <div class="ticker__item">
                  ✨ Welcome to Rwanda Pentecostal Assemblies of God Kanombe
                  Church! ✨
                </div>
                <div class="ticker__item">
                  🙏 Join us for Sunday services at 9:00 AM and 11:00 AM. 🙏
                </div>
                <div class="ticker__item">
                  📖 Bible study every Wednesday at 7:00 PM. 📖
                </div>
                <div class="ticker__item">
                  👦 Youth program every Saturday at 4:00 PM. 👧
                </div>
                <div class="ticker__item">
                  ❤️ Community outreach program on the first Saturday of every
                  month. ❤️
                </div>
              </div>
            </div>
      ...
      <div class="container-wrap">
        <aside id="fh5co-hero">
          <div class="flexslider">
            <ul class="slides">
              <li style="background-image: url(images/about.png)">
                <div class="overlay"></div>
                <div class="container-fluid">
                  <div class="row">
                    <div
                      class="col-md-6 col-md-offset-3 text-center slider-text"
                    >
        ...
        <footer id="fh5co-footer" role="contentinfo">
          <div class="row">
            <div class="col-md-4 text-center">
              ...
              <div class="contact-details">
                ...
                <p>
                  ✉️
                  <a href="mailto:rpagkanombe@gmail.com"
                    >rpagkanombe@gmail.com</a
                  >
                </p>
              </div>
            ...
            <div class="col-md-4 text-center">
              ...
              <!-- <div
                ...
                "
              >
                ASSEMBLIES OF GOD KANOMBE
              </div> -->

              <div style="margin-top: 10px">
                <img
                  src="images/logo.png"
                  alt="RPAG Kanombe Logo"
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <p>
                <small class="block"
                  >&copy; <span id="current-year"></span> RPAG Kanombe. All
