        ...
        <div class="container-wrap">
            <aside id="fh5co-hero">
                <div class="flexslider">
                    <ul class="slides">
                        <li style="background-image: url('{{ asset('Frontend/images/20001.jpg') }}')">
            ...
            <div id="fh5co-news">
                ...
                <div class="row">
                    <div class="col-md-3 animate-box">
                        <div class="news">
                            <a href="#" class="img-holder"><img class="img-responsive"
                                    src="{{ asset('Frontend/images/img-1.jpg') }}"
                    ...
                    <div class="col-md-3 animate-box">
                        <div class="news">
                            <a href="#" class="img-holder"><img class="img-responsive"
                                    src="{{ asset('Frontend/images/img-3.jpg') }}"
                                    alt="Free HTML5 Website Template by freehtml5.co" /></a>
                            <div class="desc">
                                <span class="date">March 30, 2017</span>
                    ...
                    <div class="col-md-3 animate-box">
                        <div class="news">
                            <a href="#" class="img-holder"><img class="img-responsive"
                                    src="{{ asset('Frontend/images/img-4.jpg') }}"
                                    alt="Free HTML5 Website Template by freehtml5.co" /></a>
                            <div class="desc">
                                <span class="date">March 30, 2017</span>
                    ...
                    <div class="col-md-3 animate-box">
                        <div class="news">
                            <a href="#" class="img-holder"><img class="img-responsive"
                                    src="{{ asset('Frontend/images/img-2.jpg') }}"
                                    alt="Free HTML5 Website Template by freehtml5.co" /></a>
                            <div class="desc">
                                <span class="date">March 30, 2017</span>
                                <h3><a href="#">Helping Children</a></h3>
